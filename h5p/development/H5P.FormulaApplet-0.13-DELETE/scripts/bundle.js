var H5Pbridge = (function (exports) {
    'use strict';
    ...
    function setEditHandlerActive(truefalse){
        editHandlerActive = truefalse;
    }

    function isEditHandlerActive(){
    ...
    */
    ...
    function H5P_to_MathQuill(expression, solution, language, isEditor) {
    ...
    function MathQuill_to_H5P(latex) {
    ...
    function getVirtualKeyboard(isEditor) {
        ...
        $$1(result).addClass(isEditor ? "h5pEditor" : "h5p");
    ...
    function createkeyboardDiv(isEditor) {
        var kb = $$1('#keyboard')[0];
    ...
    function initVirtualKeyboardnoEditor() {
    ...
    function showVirtualKeyboard() {
        ...
        keyboardActivate('mixed');
        $$1('#virtualKeyboard table#table_' + activeKeyboard).css('display', 'table');
        $$1('.virtualKeyboard-space')[0].innerHTML = 'free';
    }
    ...
    function processVirtualKeyboardCommand(cmd) {
        ...
        console.log(cmd);
        var mqEditableField = $$1('.formula_applet.mq-math-mode.selected').find('.mq-editable-field')[0];
        //TODO deal with case 'editor' - better use var isEditor?
        if (typeof mqEditableField === 'undefined') {
            mqEditableField = $$1('#math-field')[0];
        }
     ...
     */
    function definitionString2Array(def_with_entities) {
     ...
     * @see checkIfEquality
     */
    function checkIfEqual(leftside, data_b64, definitionSets, precision) {
    ...
    function checkIfEquality(equation, definitionSets, precision) {
    ...
    function setOkWrongTag(key, isEqual, instance) {
        // if (isH5P()) {
        //     H5P.setScoredResult(1,5,instance,false, false);
        // } else {
            var truefalse = $$1(key)[0];
            if (isEqual) {
                $$1(truefalse).css({
                    "color": "green",
                    "font-size": "30pt"
    ...
    exports.H5P_to_MathQuill = H5P_to_MathQuill;
    exports.MQ = MQ;
    exports.MathQuill_to_H5P = MathQuill_to_H5P;
    exports.checkIfEqual = checkIfEqual;
    exports.checkIfEquality = checkIfEquality;
    exports.config = config;
    exports.createWaiter = createWaiter;
    exports.createkeyboardDiv = createkeyboardDiv;
    exports.decode = decode;
    exports.docLang = docLang;
    exports.domLoad = domLoad;
    exports.encode = encode;
    exports.initVirtualKeyboardnoEditor = initVirtualKeyboardnoEditor;
    exports.isEditHandlerActive = isEditHandlerActive;
    exports.isH5P = isH5P;
    exports.keyboardActivate = keyboardActivate;
    exports.mainIsLoaded = mainIsLoaded;
    exports.makeAutoUnitstring = makeAutoUnitstring;
    exports.separateInputfield = separateInputfield;
    exports.setInput = setInput;
    exports.setOkWrongTag = setOkWrongTag;
    exports.showVirtualKeyboard = showVirtualKeyboard;
    exports.virtualKeyboardBindEvents = virtualKeyboardBindEvents;
