...
## FormulaApplet-H5P is still under development (especially the H5P part).
...
* FormulaApplet-H5P is a fork of [FormulaApplet](https://github.com/gro58/FormulaApplet), the successor of Formel-Applet (Java, closed source).
